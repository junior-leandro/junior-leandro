...
Me especializando em frontend com HTML, CSS, Boostrap, JavaScript, TypeScript, React e Next.js que são as ferramentas que atualmente mais uso no meu cotidiano.
...
[![My Skills](https://skillicons.dev/icons?i=git,github,html,css,js,ts,nodejs,react,nextjs,vite,vscode,bootstrap,vercel,figma,wordpress,ai,regex,tailwind&perline=9)](https://skillicons.dev)
#
## Perfil
